        ...
        <>
            <div className="navbar bg-gray-400 ">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 bg-clip-text text-transparent font-sans">Vikas&lsquos Portfolio</a>
